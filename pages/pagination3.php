...
<head>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ABC - Product Line Planes</title>
</head>
...
<?php
		...
		if(isset($_GET['id']))
			...
			$prodquery = "SELECT * FROM `products` where `productLine`= 'Planes' LIMIT $start, $limit";
			...
			$countrows = "SELECT * FROM `products` WHERE `productLine` = 'Planes'";
