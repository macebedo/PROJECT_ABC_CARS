...
<?php
		...
		if(isset($_GET['id']))
			...
			$prodquery = "SELECT * FROM `products` where `productLine`= 'Vintage Cars' LIMIT $start, $limit";
			...
			$countrows = "SELECT * FROM `products` WHERE `productLine` = 'Vintage Cars'";
