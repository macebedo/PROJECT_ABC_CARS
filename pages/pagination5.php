...
<head>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ABC - Product Line Trains</title>
...
<?php
		...
		if(isset($_GET['id']))
			...
			$prodquery = "SELECT * FROM `products` where `productLine`= 'Trains' LIMIT $start, $limit";
			...
			$countrows = "SELECT * FROM `products` WHERE `productLine` = 'Trains'";
