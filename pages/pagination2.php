...
<head>
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ABC - Product Line Motorcycles</title>
...
<?php
		...
		if(isset($_GET['id']))
			...
			$prodquery = "SELECT * FROM `products` where `productLine`= 'Motorcycles' LIMIT $start, $limit";
			...
			$countrows = "SELECT * FROM `products` WHERE `productLine` = 'Motorcycles'";
